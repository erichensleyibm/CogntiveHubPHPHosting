...
<html>
<head>
    <title>Cognitive Hub API.... under construction</title>
    <link rel="stylesheet" href="style.css" />
</head>

<?php
// $sqlTable="DROP TABLE IF EXISTS MESSAGES_TABLE";
$sqlTable="call ibmx_40b976d51ccb51c.sp_reset_db();";
if ($mysqli->query($sqlTable)) {
    echo "Tables set up correctly! <br>";
} else {
	//echo "Cannot set up table. "  . mysqli_error();
}
